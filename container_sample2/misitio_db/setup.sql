CREATE DATABASE  IF NOT EXISTS `robotnikdb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `robotnikdb`;
...
INSERT INTO `robot_model` VALUES (1,'modelo_tortuga',NULL,'modelo basado en turtlesim','Ros-tools',NULL,NULL),(2,'summit',NULL,'robot todoterreno','Robotnik','summit','R0b0tn1K'),(3,'rb1',NULL,'brazo y base rb1','Robotnik','rb1','R0b0tn1K');
...
INSERT INTO `robot_model_test` VALUES (2,3),(3,3),(3,5),(2,6),(3,7),(3,8);
...
INSERT INTO `robots_unit` VALUES (1,'robot_todoterreno_1','todoterreno de 4 ruedas',NULL,2,'192.168.1.137'),(2,'robot_brazo_negro','brazo y base negra',NULL,3,'158.42.165.114');
...
INSERT INTO `test` VALUES (3,'ROS and Linux version',' Verify which Ubuntu, Linux Kernel and ROS versions are installed','commands','Debe mostrar salida exitosa'),(4,'test_version_machine','Serie de comandos sobre maquina alojada','commands','Debe mostrar salida exitosa'),(5,'test_battery','Comprobar estado bateria','topic','Information'),(6,'test_battery_summit','Comprobar estado bateria','topic','Information'),(7,'test_1','Launch test 1 via python','python','rosrun test_rb1 Angular_velocity_check.py'),(8,'Peak-CAN library version',' Check the Peak-CAN version','python','Comparar la versión con la predefinida, almacenar el resultado y dar NO OK en el caso de que sean diferentes');
...
-- Dump completed on 2020-03-15 12:28:41
